(() => {
  ...
  const stageEl=document.querySelector('.classroom-stage'),builderEl=document.querySelector('#question-builder'),presentationEl=document.querySelector('#presentation-controls'),presentBtn=document.querySelector('#present-question'),backBtn=document.querySelector('#back-to-builder'),typeEl=document.querySelector('#type'),difficultyEl=document.querySelector('#difficulty'),varsEl=document.querySelector('#variables'),problemEl=document.querySelector('#problem'),answerEl=document.querySelector('#answer-panel'),labelEl=document.querySelector('#type-label'),formulaEl=document.querySelector('#formula-panel'),formulaBtn=document.querySelector('#show-formula');
  let current=null;
